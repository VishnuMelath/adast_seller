...
class PrivacyPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Privacy Policy for adast sellers'),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20),
              Text(
                'Welcome to adast sellers! Your privacy is important to us. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our application. By using adast sellers, you agree to the terms of this Privacy Policy.',
              ),
              SizedBox(height: 20),
              Text(
              ...
              _buildBulletPoint(
                'Phone Number: Used for account verification and support.',
              ),
              _buildBulletPoint(
                'Physical Address: Used for personalization and app functionality.',
              ),
              _buildBulletPoint(
                'Location Data: Used to provide users with the location of the seller.',
              ),
              _buildBulletPoint(
                'Fashion Item Details: Used to display items available in your shop.',
              ),
              _buildBulletPoint(
                'Credit Information: Used for transactions and app functionality.',
              ),
              SizedBox(height: 20),
              Text(
              ...
              _buildBulletPoint(
                'Location Services: To provide users with the location of the seller.',
              ),
              _buildBulletPoint(
